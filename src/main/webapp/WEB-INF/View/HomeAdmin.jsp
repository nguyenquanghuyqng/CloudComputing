                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="alert alert-block alert-success">
                            ...
                            <i class="ace-icon fa fa-check green"></i> Welcome to <strong class="green"> Manage Exam <small>(v1.4)</small>
                                            ...
                                            <div class="dialogs ace-scroll">
                                                ...
                                                <div class="scroll-content" style="max-height: 300px;">
                                                    <div class="itemdiv dialogdiv">
                                                        <div class="user">
                                                            <img alt="Alexa's Avatar" src="Style/HomeAdmin/images/avatar1.png">
                                                        </div>

                                                        <div class="body">
                                                            <div class="time">
                                                                <i class="ace-icon fa fa-clock-o"></i> <span class="green">4 sec</span>
                                                            </div>
                                                    ...
                                                    <div class="itemdiv dialogdiv">
                                                        <div class="user">
                                                            <img alt="John's Avatar" src="Style/HomeAdmin/images/avatar.png">
                                                        </div>
                                                    ...
                                                    <div class="itemdiv dialogdiv">
                                                        <div class="user">
                                                            <img alt="Bob's Avatar" src="Style/HomeAdmin/images/user.jpg">
                                                        </div>

                                                        <div class="body">
                                                            <div class="time">
                                                                <i class="ace-icon fa fa-clock-o"></i> <span class="orange">2 min</span>
                                                            </div>
                                                    ...
                                                    <div class="itemdiv dialogdiv">
                                                        <div class="user">
                                                            <img alt="Jim's Avatar" src="Style/HomeAdmin/images/avatar4.png">
                                                        </div>
                                                    ...
                                                    <div class="itemdiv dialogdiv">
                                                        ...
                                                        <div class="body">
                                                            <div class="time">
                                                                <i class="ace-icon fa fa-clock-o"></i> <span class="green">4 min</span>
                                                            </div>
                                            ...
                                            <form>
                                                <div class="form-actions">
                                                    <div class="input-group">
                                                        <input placeholder="Type your message here ..." type="text" class="form-control" name="message"> <span class="input-group-btn">
