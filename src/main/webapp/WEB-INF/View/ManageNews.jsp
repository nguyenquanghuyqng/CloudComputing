        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
                ...
                <head>
                    ...
                    <link rel="stylesheet" href="Style/HomeAdmin/js/jquery-ui.custom.min.css" />
                    <link rel="stylesheet" href="Style/HomeAdmin/css/fullcalendar.min.css" />


                    <!-- text fonts -->
                    <link rel="stylesheet" href="Style/HomeAdmin/css/fonts.googleapis.com.css" />

                    <!-- ace styles -->
                    <link rel="stylesheet" href="Style/HomeAdmin/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
                    ...
                    <link rel="stylesheet " href="Style/HomeAdmin/css/template.css" type="text/css ">
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            <form action="save-news" method="POST" style="align-items: center;">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <span>Headding:</span>
                                                    <input style="width: 230px;" class="form-control" type="text" name="headding" id="headding" required>
                                                </div>

                                                <div class="form-group col-sm-6">
                                                    <span>Date:</span>
                                                    <input style="width: 230px;" type="date" class="form-control" name="date" id="date" required>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <span>Content:</span>
                                                    <textarea rows="4" cols="40" style="width: 320px;" class="form-control" name="content" id="content"></textarea>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <span>Link:</span> <br>
                                                    <input style="width: 230px;" type="text" name="link" id="link" required>
                                                </div>

                                                <div class="form-group col-sm-6">
                                                    <span>Image:</span> <br>
                                                    <input style="width: 230px;" type="file" name="image" id="image">
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <button style="border: 0!important;width: 320px;" type="submit" class="btn btn-success btn-block">
									<span class="glyphicon glyphicon-ok"></span> Save
								</button>
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <button style="border: 0!important;width: 320px; margin-top: -40px;" type="reset" class="btn btn-danger btn-block">
                                    ...
                                    <div class="page-content">
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            <form action="save-candidate" method="POST" style="align-items: center;">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <span>Headding:</span>
                                                    <input style="width: 230px;" class="form-control" type="text" name="headding" value="${newss.headding }" id="headding" required>
                                                </div>

                                                <div class="form-group col-sm-6">
                                                    <span>Date:</span>
                                                    <input style="width: 230px;" type="date" class="form-control" name="date" value="${newss.date }" id="date" required>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <span>Content:</span>
                                                    <textarea rows="4" cols="40" style="width: 320px;" class="form-control" name="content" id="content">${newss.content }	</textarea>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <span>Link:</span> <br>
                                                    <input style="width: 230px;" type="text" name="link" value="${newss.link }" id="link" required>
                                                </div>

                                                <div class="form-group col-sm-6">
                                                    <span>Image:</span> <br>
                                                    <input style="width: 230px;" type="file" name="image" value="${newss.image }" id="image" required>
                                                </div>
